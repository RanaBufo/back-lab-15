        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductsCategories_Categories_IdCategory",
                        column: x => x.IdCategory,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductsCategories_Products_IdProduct",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductsColors_Colors_IdColor",
                        column: x => x.IdColor,
                        principalTable: "Colors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductsColors_Products_IdProduct",
                        column: x => x.IdProduct,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductsCompositions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductsCompositions_Compositions_IdComposition",
                        column: x => x.IdComposition,
                        principalTable: "Compositions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductsCompositions_Products_IdProduct",
                        column: x => x.IdProduct,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Room = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Intercom = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Baskets_Products_IdProduct",
                        column: x => x.IdProduct,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addesses_IdUser",
                table: "Addesses",
                column: "IdUser");

            migrationBuilder.CreateIndex(
                name: "IX_Baskets_IdProduct",
                table: "Baskets",
                column: "IdProduct");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductsCategories_IdCategory",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductsColors_IdColor",
                table: "ProductsColors",
                column: "IdColor");

            migrationBuilder.CreateIndex(
                name: "IX_ProductsColors_IdProduct",
                table: "ProductsColors",
                column: "IdProduct");

            migrationBuilder.CreateIndex(
                name: "IX_ProductsCompositions_IdComposition",
                table: "ProductsCompositions",
                column: "IdComposition");

            migrationBuilder.CreateIndex(
                name: "IX_ProductsCompositions_IdProduct",
                table: "ProductsCompositions",
                column: "IdProduct");
